...
# Borehole03(stepstorun=2:2,laGP.nuggets=c('E',1e-6),laGP.nuggets.names=c('E',6),JMP.include=F,external.fits='JMP', Python.include=T, GPy.include=F, GPfit.include=F, mlegp.include=F, Dice.include=F, laGP.include=F, DACE.include=F)
...
# Detpep108d2(stepstorun=2:2,laGP.nuggets=c('E',1e-6),laGP.nuggets.names=c('E',6),JMP.include=F,external.fits='JMP', Python.include=T, GPy.include=F, GPfit.include=F, mlegp.include=F, Dice.include=F, laGP.include=F, DACE.include=F)
