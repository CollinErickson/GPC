...
if len(sys.argv) > 1:
    ...
    filesToRunName = "//sscc//home//c//cbe117//Research//GPC//GPC_Output//Borehole03//Borehole03_D8_SS200_PS2000_R5//RunFiles//filesToRunGPyM52.csv"
    filesToRunName = "//sscc//home//c//cbe117//Research//GPC//GPC_Output//Morris1//Morris1_D20_SS200_PS2000_R5//RunFiles//filesToRunGPyM52.csv"
...
for i in range(1,numberToRun+1):
    ...
    # 1/11/17 Changing this file from RBF to Matern 5/2
    kernel = GPy.kern.Matern52(input_dim=inputdim, ARD=True) # Cut out unnecessary parameters 4/20/16
    #print(filesToRun)
